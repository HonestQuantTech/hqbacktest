...
class Fill:
    ...
    def __post_init__(self) -> None:
        ...
        # 印花税 is charged only on SELL. A BUY fill carrying a non-zero
        # stamp_tax would let the cash ledger drift from the costs
        # table, so we reject it at construction time.
